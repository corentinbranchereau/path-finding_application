...
public class CommandTest {
    ...
    /**
     * Instancie une carte avec des requêtes et le calcul d'une tournée pour
     * effectuer ensuite différentes actions
     * 
     ...
     * @throws IOException               Exception lors de la lecture du fichier sur
     *                                   le disque
     * @throws BadFileTypeException      Exception sur le type du fichier chargé
     *                                   (carte ou requête)
     ...
     */
    @BeforeEach
    void init() throws URISyntaxException, SAXException, FileBadExtensionException, DTDValidationException, IOException,
            BadFileTypeException, IllegalAttributException, RequestOutOfMapException {
        carte = new Carte();
        planning = new Planning(carte);

        Document xmlCarte = XMLFileOpener.getInstance().ouvrirXml("./src/test/resources/smallMap.xml", TypeDTD.CARTE);
        XMLDeserializer.chargerCarte(carte, xmlCarte);

        Document xmlRequete = XMLFileOpener.getInstance().ouvrirXml("./src/test/resources/requestsSmall2.xml",
                TypeDTD.REQUETE);
        XMLDeserializer.chargerRequetes(xmlRequete, planning);
    ...
    public void doisAjouterDemande() {
        ...
        Requete nouvelleRequete = new Requete(25611760, 120, "pickup", TypeDemande.COLLECTE);
        Demande nouvelleDemande = nouvelleRequete.getDemandeCollecte();
        listOfCommands.ajouterCommande(new AjouterDemandeCommand(planning, nouvelleDemande));
    ...
    public void doisRetirerDemande() {
        ...
        listOfCommands.ajouterCommande(new SupprimerDemandeCommand(planning, demande));
    ...
    /**
     * Test le redo après l'ajout d'une demande puis un undo dans une tournée déjà
     * calculée
     */
    @Test
    ...
    /**
     * Test le redo après la suppression d'une demande puis un undo dans une tournée
     * déjà calculée
     */
    @Test
    ...
    public void doisAjouterRequete() {
        ...
        listOfCommands.ajouterCommande(new AjouterRequeteCommand(planning, nouvelleRequete));
    ...
    public void doisRetirerRequete() {
        ...
        listOfCommands.ajouterCommande(new SupprimerRequeteCommand(planning, requete));
    ...
    /**
     * Test le redo après l'ajout d'une requête puis un undo dans une tournée déjà
     * calculée
     */
    @Test
    ...
    /**
     * Test le redo après la suppression d'une requête puis un undo dans une tournée
     * déjà calculée
     */
    @Test
    ...
    public void doisModifierDemande() {
        ListOfCommands listOfCommands = new ListOfCommands();
        listOfCommands.ajouterCommande(
                new ModifierDemandeCommand(planning, planning.getDemandesOrdonnees().get(0), 120, 26086114L));
    ...
    public void doisModifierPlanning() {
        ...
        listOfCommands.ajouterCommande(new ModifierPlanningCommand(planning, 0, 1));
    ...
    /**
     * Test l'undo après la modification d'une demande dans une tournée déjà
     * calculée
     */
    @Test
    ...
    /**
     * Test l'undo après la modification d'un planning dans une tournée déjà
     * calculée
     */
    @Test
    ...
    /**
     * Test le redo après la modification d'une demande puis un undo dans une
     * tournée déjà calculée
     */
    @Test
    ...
    /**
     * Test le redo après la modification d'un planning puis un undo dans une
     * tournée déjà calculée
     */
    @Test
